        ...
        <section className='policy'>
            ...
            <div className="policy__container">
                <div className="policy__content">
                    ...
                    <h1>Contact us</h1>
                    <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at help@lelustore.com or by mail using the details provided below:</p>
                </div>
            </div>
        </section>
    )
